...
# Load the data
#%%
promoter_sim_file = f"./results/pairwise_alignment/{family_id}_promoter_alignment.tsv"
domain_sim_file = f"./results/pairwise_alignment/{family_id}_protein_alignment.tsv"
expression_sim_file = f"./results/expression_similarity/{family_id}_{transform_method}_exp_similarity.tsv"
orthologs_mapped_file = f"./data/db_ids/human_mouse_one2one_filtered_mapped.txt"
...
combined_df.to_csv(f"./results/combined_similarity/{family_id}_{transform_method}_combined_similarity.tsv", sep="\t", index=False)
# %%
